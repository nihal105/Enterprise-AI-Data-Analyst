...
with st.sidebar:
    ...
    st.markdown('<div class="nav-label">Developers</div><div class="nav-value">Nihaall · Shifana · Murshid</div>', unsafe_allow_html=True)
...
<div class="topbar">
    <div>
        ...
        <div class="topbar-subtitle">Business datasets analyzed with AI, NLP, and interactive analytics</div>
    </div>
...
st.markdown(
    '<div class="footer">Enterprise AI Data Analyst &nbsp;·&nbsp; Final Year Deep Learning Project &nbsp;·&nbsp; Version 1.0 &nbsp;·&nbsp; ©️ 2026</div>',
    unsafe_allow_html=True,
)